...
///
/// Used instead of CryptoKit so PKCE challenge derivation stays a pure value
/// computation with no platform-availability gating on the public API and
/// remains runnable under command-line SwiftPM. Correctness is pinned by the
/// RFC 7636 Appendix B test vector in `PkceTests`.
enum Sha256 {
